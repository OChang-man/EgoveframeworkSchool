...
<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale-1.0,maximum-sacle=1.0,user-scalable=no" />
				...
				<ul>
					...
					<c:choose>
						<c:when test="${empty USER_INFO.id}">
							<li><a href="/uat/uia/egoveLoginUsr.do">로그인</a></li>								
						</c:when>
						<c:otherwise>
							<li><strong><c:out value="${USER_INFO.name}"></c:out></strong>님 환영합니다</li>
